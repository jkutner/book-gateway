...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "BookGateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "BookGateway API";

        private String description = "BookGateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "BookGateway";
