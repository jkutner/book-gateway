(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('bookGatewayApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-bookGatewayApp-error');
                var entityKey = httpResponse.headers('X-bookGatewayApp-params');
                if (errorHeader) {
